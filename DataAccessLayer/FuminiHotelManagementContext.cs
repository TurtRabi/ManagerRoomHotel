...
public partial class FuminiHotelManagementContext : DbContext
{
    ...
    //      => optionsBuilder.UseSqlServer("server = MINHOAN\\SQLEXPRESS; database = FUMiniHotelManagement;uid=sa;pwd=12345;Trusted_Connection=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.HasIndex(e => e.EmailAddress, "UQ__Customer__49A14740904BD863").IsUnique();
